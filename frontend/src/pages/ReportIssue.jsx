...
//     try {
//       // FIXED: Better coordinate validation with fallback
//       let lat, lng
...
//         lat = typeof location[0] === 'number' ? location[0] : parseFloat(location[0])
//         lng = typeof location[1] === 'number' ? location[1] : parseFloat(location[1])
...
const ReportIssue = () => {
  ...
  // Handle form submission - SIMPLE VERSION THAT WORKS
  const handleSubmit = async () => {
    // Check if offline
    if (isOffline) {
      toast.error('You are offline. Please check your internet connection.')
    ...
    try {
      // SIMPLE DATA STRUCTURE THAT WORKS - no parsing or validation
      const reportData = {
        category,
        title,
        description,
        priority,
        latitude: location[0],  // Direct assignment without parsing
        longitude: location[1], // Direct assignment without parsing
        address,
        locationDetails,
        isAnonymous,
        allowComments,
