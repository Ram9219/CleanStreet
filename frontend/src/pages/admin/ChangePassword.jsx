...
//         // Refresh user to update requiresPasswordChange status
//         await refreshUser()
...
//           <LockReset sx={{ fontSize: 60, color: 'warning.main', mb: 2 }} />
...
//           Note: You will be redirected to the dashboard after changing your password
//         </Typography>
//       </Paper>
//     </Container>
//   )
